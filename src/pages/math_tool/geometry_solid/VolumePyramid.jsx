...
const VolumePyramid = () => {
    ...
    const [baseArea, setBaseArea] = useState(12);
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(mathActions.actionVolumePyramid({
            base_area: baseArea,
            height: height
        }));
    };
    ...
    return (
        <div className={commonClasses.container}>
            ...
            <TheorySection
                ...
                icon="📚"
                formula={String.raw`$$V = \frac{1}{3} \times S_{đáy} \times h$$`}
                description={
                    <>
                        Thể tích khối chóp được tính bằng <strong>một phần ba</strong> tích của{' '}
                        <strong>diện tích đáy</strong> và <strong>chiều cao</strong>
                    </>
                }
                example={`$V = \\frac{1}{3} \\times 12 \\times 6 = 24$ (đơn vị khối)`}
            />
            ...
            <div className={`${commonClasses.card} ${commonClasses.cardPadding}`}>
                ...
                <div className={`${commonClasses.mathDisplay} mb-6`}>
                    <div className="tex2jax_process text-sm sm:text-base lg:text-lg">
                        {String.raw`$$V = \frac{1}{3} \times S_{đáy} \times h$$`}
                    </div>
                </div>
                                    ...
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm">
                                                {String.raw`Áp dụng công thức: $V = \frac{1}{3} \times S_{đáy} \times h$`}
                                            </span>
                                        </td>
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm">
                                    ...
                                    <tr className="bg-white border-b border-gray-200">
                                        ...
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm break-all">
                                                {`$V = \\frac{1}{3} \\times ${baseArea} \\times ${height}$`}
                                            </span>
                                        </td>
                                    </tr>
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm break-all">
                                                {`$V = \\frac{${baseArea} \\times ${height}}{3} = \\frac{${baseArea * height}}{3}$`}
                                            </span>
                                        </td>
                                    </tr>
                                    <tr className="bg-white border-b border-gray-200">
                        ...
                        <div className={commonClasses.successBox}>
                            <div className="text-center">
                                ...
                                <div className="mt-3 p-2 bg-white rounded border overflow-x-auto">
                                    <div className="tex2jax_process text-xs sm:text-sm">
                                        <div className="mt-2">
                                            {`$V = \\frac{1}{3} \\times ${baseArea} \\times ${height} = ${result.value}$`}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-3 p-2 bg-blue-50 rounded border">
                                    <div className="text-xs sm:text-sm text-gray-700">
                                        <strong>Ý nghĩa:</strong> Thể tích của khối chóp có diện tích đáy{' '}
                            ...
                            <div className="mt-4 text-center">
                                <h5 className="text-xs sm:text-sm font-semibold text-gray-700 mb-2">
                                    💡 Kiến thức về khối chóp:
                                </h5>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-gray-600">
                                    <div className="tex2jax_process">
                                        {String.raw`Chóp đều: $V = \frac{1}{3} \times S_{đáy} \times h$`}
                                    </div>
                                    <div className="tex2jax_process">
                                        {String.raw`Chóp tam giác: $V = \frac{1}{3} \times S_{\triangle} \times h$`}
                                    </div>
                                    <div className="tex2jax_process">
                                        {String.raw`Chóp tứ giác: $V = \frac{1}{3} \times S_{tứ giác} \times h$`}
                                    </div>
                                    <div className="tex2jax_process">
                                        {String.raw`Hình nón: $V = \frac{1}{3} \times \pi r^2 \times h$`}
                                    </div>
                                </div>
                            </div>
                        </div>
