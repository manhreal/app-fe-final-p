...
const Combination = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(mathActions.actionCombination({ n, k }));
    };
    ...
    return (
        <div className={commonClasses.container}>
            ...
            <TheorySection
                ...
                icon="📚"
                formula={String.raw`$$C(n,k) = \binom{n}{k} = \frac{n!}{k!(n-k)!}$$`}
                description={
                    <>
                        Tổ hợp chập k của n phần tử là số cách chọn k phần tử từ n phần tử mà{' '}
                        <strong>không phân biệt thứ tự</strong>
                    </>
                }
                example="$C(5,2) = \frac{5!}{2!(5-2)!} = \frac{5!}{2! \cdot 3!} = 10$"
            />
                                    ...
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm">
                                                {"Áp dụng công thức: $C({n},{k}) = \\frac{{n}!}{{k}!(n-k)!}$"}
                                            </span>
                                        </td>
                                        <td className={commonClasses.tableCell}>
                                            <span className="tex2jax_process text-xs sm:text-sm">
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-3 p-2 bg-blue-50 rounded border">
                                    <div className="text-xs sm:text-sm text-gray-700">
                                        <strong>Ý nghĩa:</strong> Có <span className="font-bold text-blue-600">{result?.['C(n,k)'] || result?.result}</span> cách
